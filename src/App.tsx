...
function Loading() {
  return <div className="center-screen"><div className="spinner" />Đang tải…</div>;
}
    ...
    <BrowserRouter>
      <Suspense fallback={<Loading />}>
        <Routes>
          ...
          <Route path="*" element={<main className="empty-state"><h1>Không tìm thấy trang</h1><a href="/">Về trang tin</a></main>} />
        </Routes>
      </Suspense>
    </BrowserRouter>
  );
